...
def send_otp_code(phone_number, code):
    try:
        ...
        pattern_code = settings.SMS_PATTERN_CODE
        sender = settings.SMS_SENDER
        response = client.send_pattern(pattern_code=pattern_code, sender=sender, recipient=phone_number_str, values={"verification-code": code})
        print(response)
