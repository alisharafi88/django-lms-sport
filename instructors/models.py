...
class Instructor(models.Model):
    ...
    description = models.TextField(_('description of instructor'))
    exprience = models.PositiveIntegerField(_('exprience'), help_text=_('How many years of experience do you have?!'))
    telegram_id = models.CharField(max_length=50, blank=True, null=True, help_text=_('Your telegram id for showing in your profile!'))
    youtube_id = models.CharField(max_length=50, blank=True, null=True, help_text=_('Your youtube id for showing in your profile!'))
    instagram_id = models.CharField(max_length=50, blank=True, null=True, help_text=_('Your instagram id for showing in your profile!'))
